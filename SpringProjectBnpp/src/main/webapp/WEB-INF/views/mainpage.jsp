          ...
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><a href="#contact">Message Us</a></li>  --> 
               <li class="scroll-to-section"><div class="main-blue-button"><a href="#contact">로그인</a></div></li>       
              <li class="scroll-to-section"><div class="main-red-button"><a href="#contact">회원가입</a></div></li>
            </ul>        
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="resources/assets/images/banner-right-image.png" alt="team meeting">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="left-image wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
            <img src="resources/assets/images/about-left-image.png" alt="person graphic">
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                  <div class="icon">
                    <img src="resources/assets/images/service-icon-01.png" alt="reporting">
                  </div>
          ...
          <a href="#">
            <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.3s">
              ...
              <div class="showed-content">
                <img src="resources/assets/images/portfolio-image.png" alt="">
              </div>
            </div>
          </a>
        </div>
        <div class="col-lg-3 col-sm-6">
          <a href="#">
            <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.4s">
              ...
              <div class="showed-content">
                <img src="resources/resources/assets/images/portfolio-image.png" alt="">
              </div>
            </div>
          </a>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.25s">
          <div class="left-image">
            <a href="#"><img src="resources/assets/images/big-blog-thumb.jpg" alt="Workspace Desktop"></a>
            <div class="info">
            ...
            <ul>
              <li>
                ...
                <div class="right-image">
                  <a href="#"><img src="resources/assets/images/blog-thumb-01.jpg" alt=""></a>
                </div>
              </li>
              <li>
                <div class="left-content align-self-center">
