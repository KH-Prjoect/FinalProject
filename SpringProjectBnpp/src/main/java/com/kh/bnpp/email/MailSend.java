...
public class MailSend {
	...
	public static void sendEmail(String to, String subject, String content) 
		 ...
		 props.put("mail.smtp.starttls.enable","true");		// 로그인 할때 Transport Layer Security(TLS)를 사용할 것인지 설정
		
		 props.setProperty("mail.smtp.socketFactory.class","javax.net.ssl.SSLSocketFactory"); // gmail 인증용 Secure Socket Layer(SSL) 설정
